...
latex_documents = [
  ('index', 'ArborWorkflows.tex', 'Arbor Workflows Documentation',
   'Kitware, Inc.', 'manual'),
]
...
man_pages = [
    ('index', 'arborworkflows', 'Arbor Workflows Documentation',
     ['Kitware, Inc.'], 1)
]
...
texinfo_documents = [
  ('index', 'ArborWorkflows', 'Arbor Workflows Documentation',
   'Kitware, Inc.', 'ArborWorkflows', 'One line description of project.',
   'Miscellaneous'),
]
