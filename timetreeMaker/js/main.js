...
(function (flow, $, girder) {
    ...
    $(document).ready(function () {
        ...
        app.analysisName = "WF Obtain Time-Calibrated Phylogeny from a List of Taxa";
        girder.restRequest({
        ...
        $("#analyze").click(function() {
            ...
            $("#analyze").text("Re-run");
            $("#notice").text("Querying OpenTree and building chronogram...");
            ...
            var outputs = {
                citations: {type: "table", format: "rows"},
