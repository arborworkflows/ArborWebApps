...
(function (flow, $, girder) {
    ...
    $(document).ready(function () {
        ...
        app.readyToAnalyze = function () {
            if ("columnx" in this && "columny" in this && "table" in this && "tree" in this &&
                "analysisId" in this) {
        ...
        $("#column-input-y").droppable({
            drop: function( event, ui ) {
                ...
                d3.select("#column-input-y")
                    ...
                    .html('Y = ' + COI + ' <span class="glyphicon glyphicon-ok-circle"></span>');
                app.readyToAnalyze();
            },
            ...
            $("#column-input-x").droppable({
                drop: function( event, ui ) {
                    ...
                    d3.select("#column-input-x")
                        ...
                        .classed('btn-success', false)
                        .classed('bg-warning', false)
                        .html('X = ' + COI + ' <span class="glyphicon glyphicon-ok-circle"></span>');
                    app.readyToAnalyze();
                },
                over: function (event, ui) {
                    d3.select("#column-input-x")
